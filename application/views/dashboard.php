...
<ol class="breadcrumb" xmlns="http://www.w3.org/1999/html" xmlns="http://www.w3.org/1999/html">
                ...
                <li class="breadcrumb-item active">UTeM UC Dashboard</li>
            </ol>
                ...
                <div class="col-xl-3 col-sm-6 mb-3">
                    <div class="card card-inverse card-primary o-hidden h-100">
                        <div class="card-block">
                            ...
                            <div class="mr-5">
                                Total Valid StaffID</br> 2026
                            </div>
                        </div>
                        <a href="staffid_report" class="card-footer clearfix small z-1">
            ...
            <div class="card mb-3">
                <div class="card-header">
                    <i class="fa fa-area-chart"></i> Inbound/Outbound Calls
                </div>
                <div class="card-block">
                    <canvas id="myAreaChart" width="100%" height="30"></canvas>
                </div>
                <div class="card-footer small text-muted">
                    Updated today at 00:01 AM
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="card mb-3">
                        <div class="card-header">
                            <i class="fa fa-bell-o"></i> Recently added users
                        </div>
